...
router.post('/register', [
  ...
  try {
    ...
    // If registering as artist — auto-create empty ArtistProfile
    if (user.role === 'artist') {
    ...
    // Password format error from pre-save hook
